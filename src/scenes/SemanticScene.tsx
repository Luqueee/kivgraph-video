...
/**
 * Scene 05 - semantic resolution (master 1200-1400, scene-local 0000-0200).
 *
 ...
 * freezes. The code world never leaves, and master 1200 has to be
...
export const SemanticScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: brand.background }}>
       ...
       * the two frames either side of 0770 cannot disagree about it.
       */}
